      ...
      <div className="grid grid-cols-5 gap-4">
        ...
        <div className="col-span-3 space-y-4">
          <div className="space-y-4">
            <p className="text-3xl text-tenor text-sage-dark">Form Booking</p>
            <p className="text-base text-tenor text-sage-soft">Submit your booking request. If we accept or refuse, we will contact you via WhatsApp or email.</p>
          </div>
          <div>
